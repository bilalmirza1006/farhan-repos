const LandingHeader = ({ text, icon, color, bg, cn, ...rest }) => {
  return (
    <button
      {...rest}
      className={`group relative overflow-hidden py-3 px-6 rounded-md
        ...
        bg-[#C7044C] text-white backdrop-blur-md
    ...
    >
      ...
      <span
        ...
        bg-[#ef5f94] rounded-[100%] -translate-x-1/2
...
// export default LandingLandingHeader
