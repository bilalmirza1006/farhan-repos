...
const ApplyModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div
      className="fixed inset-0 bg-[#0000004D] flex items-center justify-center z-50"
      onClick={onClose}
    >
      <div
        className="relative bg-white px-6 py-8 rounded-3xl shadow-lg w-full max-w-[720px] m-5 md:m-0"
      ...
      >
        ...
        <div className="text-center mt-5">
          ...
          <p className="font-roboto font-normal text-xl text-Lighttext">
            Please enter your basic details to proceed. You’ll be redirected to
            your dashboard to track your application.
          </p>
        </div>
